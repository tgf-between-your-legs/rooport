...
if (process.argv.length === 4 && process.argv[2] === '--finalize-index') {
  mode = 'finalize';
  ...
  console.error('Usage:');
  console.error('  node create_kb_from_json.js <path_to_llms_or_chunk.json> <library_name>');
  console.error('  node create_kb_from_json.js --finalize-index <library_name>');
  process.exit(1);
}
