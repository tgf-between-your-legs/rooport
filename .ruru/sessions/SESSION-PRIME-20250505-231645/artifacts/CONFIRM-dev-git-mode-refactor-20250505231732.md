...
# ]
related_context = [ # << UPDATED >> Added MCP context
...
*   **Suggest MCP Installation:** Can prompt the user to install the GitHub MCP via `@agent-mcp-manager` if it's missing but could be beneficial.
