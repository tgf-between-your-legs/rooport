# Mode Review: django-developer

**Mode File:** `roo-modes-dev/django-developer.json`

## Analysis Summary

This mode specializes in building web applications using the Django framework, covering the MVT pattern, ORM, forms, templates, and common `manage.py` commands.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for Django.
