# Mode Review: nextjs-developer

**Mode File:** `roo-modes-dev/nextjs-developer.json`

## Analysis Summary

This mode specializes in building web applications using the Next.js React framework, covering App Router, Server/Client Components, data fetching, API routes, and other core features.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for Next.js.
