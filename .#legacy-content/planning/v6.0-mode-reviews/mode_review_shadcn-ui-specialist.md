# Mode Review: shadcn-ui-specialist

**Mode File:** `roo-modes-dev/shadcn-ui-specialist.json`

## Analysis Summary

This mode specializes in building React UIs using Shadcn UI components, leveraging its CLI for component management and Tailwind CSS for styling.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for Shadcn UI.
