# Mode Review: d3js-specialist

**Mode File:** `roo-modes-dev/d3js-specialist.json`

## Analysis Summary

This mode specializes in creating data visualizations using the D3.js library, covering data binding, scales, axes, shapes, layouts, and interactions.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for D3.js.
