# Mode Review: animejs-specialist

**Mode File:** `roo-modes-dev/animejs-specialist.json`

## Analysis Summary

This mode specializes in creating web animations using the anime.js library. It includes steps for planning, implementation, consulting documentation, testing, and reporting.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for anime.js.
