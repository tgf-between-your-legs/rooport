# Mode Review: threejs-specialist

**Mode File:** `roo-modes-dev/threejs-specialist.json`

## Analysis Summary

This mode specializes in creating 3D graphics and animations for the web using the Three.js library, covering scene setup, asset loading, rendering loops, and editor extensions.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for Three.js.
