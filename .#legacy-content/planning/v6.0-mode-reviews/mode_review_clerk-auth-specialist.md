# Mode Review: clerk-auth-specialist

**Mode File:** `roo-modes-dev/clerk-auth-specialist.json`

## Analysis Summary

This mode specializes in integrating Clerk authentication and user management, covering frontend components, backend protection, and SDK usage.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for Clerk.
