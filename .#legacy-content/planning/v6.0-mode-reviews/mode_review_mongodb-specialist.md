# Mode Review: mongodb-specialist

**Mode File:** `roo-modes-dev/mongodb-specialist.json`

## Analysis Summary

This mode specializes in MongoDB, covering schema design, CRUD operations, aggregation pipelines, indexing, security, and administration tasks.
...
3.  **Embedded Context:** The mode definition includes a large embedded "Condensed Context Index" for MongoDB.
