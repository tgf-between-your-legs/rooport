        ...
        if logged_decision and logged_decision.id is not None:
            try:
                ...
                metadata_for_vector = {
                    ...
                    "tags": ", ".join(logged_decision.tags) if logged_decision.tags else ""
                }
            ...
            if text_to_embed:
                ...
                try:
                    ...
                    metadata_for_vector = {
                        ...
                        "key": logged_data.key,
                        "timestamp_created": logged_data.created_date.isoformat() if hasattr(logged_data, 'created_date') else datetime.utcnow().isoformat(),
