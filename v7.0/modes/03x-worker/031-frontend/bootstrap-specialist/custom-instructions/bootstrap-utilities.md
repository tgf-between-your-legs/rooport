...
*   **Size:**
    ...
    *   `1` - `$spacer * .25`
    *   `2` - `$spacer * .5`
    *   `3` - `$spacer * 1` (default `$spacer` is 1rem)
    *   `4` - `$spacer * 1.5`
    *   `5` - `$spacer * 3`
...
*   **Font Size (v5):** `.fs-{1-6}` (relative to heading sizes). *v4 used `.h{1-6}` classes or responsive display classes.*
...
*   **Text Color:** `.text-{primary|secondary|success|danger|warning|info|light|dark|white|body|muted|black-50|white-50}`.
*   **Background Color:** `.bg-{primary|secondary|success|danger|warning|info|light|dark|white|transparent|body}`.
*   **Opacity (v5):** `.opacity-{100|75|50|25}`.

**6. Borders:**

*   **Add/Remove:** `.border`, `.border-0`, `.border-top-0`, etc.
*   **Color:** `.border-{primary|secondary|success|etc.}`.
*   **Width (v5):** `.border-{1-5}`.
